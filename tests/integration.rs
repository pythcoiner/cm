    ...
    TasksState {
        ...
        phases: vec![Phase {
            ...
            tasks: vec![Task {
                ...
                plan_file: ".cm/plans/plan-test-feature.md".to_string(),
                attempts: vec![],
        ...
        phases: vec![Phase {
            ...
            tasks: vec![
                Task {
                    ...
                    plan_file: ".cm/plans/plan-task-a.md".to_string(),
                    attempts: vec![],
                    roadmap_item_id: None,
                    implem_completed_at: None,
                    baseline_commit: None,
                ...
                Task {
                    ...
                    plan_file: ".cm/plans/plan-task-b.md".to_string(),
                    attempts: vec![],
                    roadmap_item_id: None,
                    implem_completed_at: None,
                    baseline_commit: None,
                ...
                Task {
                    ...
                    plan_file: ".cm/plans/plan-task-b-review.md".to_string(),
                    attempts: vec![],
                    roadmap_item_id: None,
                    implem_completed_at: None,
                    baseline_commit: None,
...
fn test_basic_state_flow() {
    ...
    state.phases.push(Phase {
        ...
        tasks: vec![Task {
            ...
            plan_file: ".cm/plans/plan-do-task.md".to_string(),
            attempts: vec![],
            roadmap_item_id: None,
            implem_completed_at: None,
            baseline_commit: None,
    ...
    state.phases.push(Phase {
        ...
        tasks: vec![
            Task {
                ...
                plan_file: ".cm/plans/plan-implement.md".to_string(),
                attempts: vec![],
                roadmap_item_id: None,
                implem_completed_at: None,
                baseline_commit: None,
            ...
            Task {
                ...
                plan_file: ".cm/plans/plan-review-impl.md".to_string(),
                attempts: vec![],
                roadmap_item_id: None,
                implem_completed_at: None,
                baseline_commit: None,
            ...
            Task {
                ...
                plan_file: ".cm/plans/plan-fix-issues.md".to_string(),
                attempts: vec![],
                roadmap_item_id: None,
                implem_completed_at: None,
                baseline_commit: None,
            ...
            Task {
                ...
                plan_file: ".cm/plans/plan-write-tests.md".to_string(),
                attempts: vec![],
                roadmap_item_id: None,
                implem_completed_at: None,
                baseline_commit: None,
    ...
    state.phases = vec![
        Phase {
            ...
            tasks: vec![Task {
                ...
                plan_file: ".cm/plans/plan-phase1-task.md".to_string(),
                attempts: vec![],
                roadmap_item_id: None,
                implem_completed_at: None,
                baseline_commit: None,
        ...
        Phase {
            ...
            tasks: vec![
                Task {
                    ...
                    plan_file: ".cm/plans/plan-phase2-task1.md".to_string(),
                    attempts: vec![],
                    roadmap_item_id: None,
                    implem_completed_at: None,
                    baseline_commit: None,
                ...
                Task {
                    ...
                    plan_file: ".cm/plans/plan-phase2-task2.md".to_string(),
                    attempts: vec![],
                    roadmap_item_id: None,
                    implem_completed_at: None,
                    baseline_commit: None,
