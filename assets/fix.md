...
This command guides users through adding a bug fix task to an existing cm (Claude Code Manager) project. The wizard collects bug details, investigates autonomously, and presents a complete fix plan for the user to confirm via `/end`.
...
If creating a new phase, generate a detailed phase plan following the `.cm/agents/PLAN.md` template.
...
>
> **Plan file:** `.cm/plans/plan-[phase].md`
>
> **Task definition:**
> ```json
> {
